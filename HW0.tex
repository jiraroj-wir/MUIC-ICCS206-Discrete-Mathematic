...
\begin{enumerate}
    \item[4.1)] \boxed{NO}, $A$ is true, but $B$ is a false proposition. In $A$ case, for all $x$, will exist $y$, such that $x + y = 23$. But, in $B$ case, there's no such y that satisfy all integer of x --- when plugged into an equation of $x + y = 23$
    \item[4.2)] 
          \begin{enumerate}
              \item[(A)] “Every boy secretly likes at least one girl implies that some girl is secretly liked by every boy.” --- this implication chain is \boxed{\text{FALSE}} since "every boy secretly likes at least one girl" doesn't necessary means "there's a girl that are secretly liked by every boy".
              \item[(B)] “There exists a girl secretly liked by every boy implies that every boy secretly likes at least one girl.” --- this implication chain is \boxed{\text{TRUE}} --- if "there exist a girl that are liked by every boy", then "all the boys will have some girl that they all liked"
          \end{enumerate}
\end{enumerate}
